...
<nav>
  ...
  <div class="nav-right">
    ...
    <a href="#" class="nav-link hidden" id="nav-stories">stories</a>
    <a href="#" class="nav-link hidden" id="nav-favorites">favorites</a>
...
<!-- Submit Story Form -->
<section>
  <form id="submit-form" class="hidden" action="#">
    <h4>Make Post</h4>
    <p>Input the story's title, auhtor, and URL below:</p>
    <input id="post-title" placeholder="title" type="text">
    <input id="post-author" placeholder="author" type="text">
    <input id="post-URL" placeholder="somedomain.com" type="text">
